...
/**
 * Code By: imbroisi
 * Code source: https://github.com/imbroisi/medium-react-webp/blob/master/src/components/ImageWebp/ImageWebp.jsx
 */
...
class ImageWebp extends PureComponent {
  ...
  componentDidMount() {
    //this.actualSrc === transparentImage signs we have to test compatibility first.
