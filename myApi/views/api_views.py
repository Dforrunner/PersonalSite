...
from myApi.serializers import SidebarSerializer, HomeSerializer, AboutSerializer, ExperienceSerializer, \
    SkillsSerializer, ProjectsSerializer, ContactSerializer, SkillNamesSerializer, GoogleMapSerializer
from myApi.models import Sidebar, Home, About, Experience, Skills, SkillNames, Contact, Projects, GoogleMap
